package com.example.demo.wxjumphack;
...
public class Hack {
    ...
    static final String ADB_PATH = "D:\\software\\androidsdk\\platform-tools/adb";

    /**
     * 弹跳系数，现在已经会自动适应各种屏幕，请不要修改。
     */
//    static final double JUMP_RATIO = 1.398f;
    static final double JUMP_RATIO = 1.433f;
